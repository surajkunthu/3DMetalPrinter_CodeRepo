...
#define EXTRUDER_SWITCH_XY_SPEED 0
...
#define Y2_STEP_PIN   ORIG_E0_STEP_PIN
#define Y2_DIR_PIN    ORIG_E0_DIR_PIN
#define Y2_ENABLE_PIN ORIG_E0_ENABLE_PIN
...
#define MOTOR_DRIVER_1(var) StepperDriver<-1,-1,-1,0,0> var(100,10)
